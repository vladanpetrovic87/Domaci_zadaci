...
<body>
    ...
    <h1>Tabelarni prikaz svih filmova</h1>

    <?php


    $f = "SELECT filmovi.id, filmovi.naslov AS 'naziv', reziseri.ime AS 'ime', reziseri.prezime AS 'prezime', filmovi.godina AS 'godina', filmovi.ocena AS 'ocena', zanrovi.naziv AS 'zanr' 
    FROM reziseri
    INNER JOIN filmovi
